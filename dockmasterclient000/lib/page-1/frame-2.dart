        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              padding: EdgeInsets.fromLTRB(92*fem, 23*fem, 100.5*fem, 0*fem),
              width: double.infinity,
              height: 125*fem,
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.center,
                children: [
                  Container(
                    // ownerESg (17:790)
                    margin: EdgeInsets.fromLTRB(0*fem, 17*fem, 18.92*fem, 39*fem),
                  ...
                  Container(
                    // logoG1z (26:20)
                    margin: EdgeInsets.fromLTRB(0*fem, 15*fem, 20*fem, 37*fem),
                    width: 38*fem,
                    height: double.infinity,
                    child: Stack(
                      children: [
                  ...
                  Container(
                    // proVor (17:893)
                    margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 135*fem, 11*fem),
                    child: Text(
                      'ProДокументы',
                      style: SafeGoogleFont (
                        'Vollkorn',
                  ...
                  Container(
                    // oZe (17:889)
                    margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 50.13*fem, 23*fem),
                    child: TextButton(
                      onPressed: () {},
                  ...
                  Container(
                    // JFW (17:890)
                    margin: EdgeInsets.fromLTRB(0*fem, 1*fem, 28.87*fem, 0*fem),
                  ...
                  Container(
                    ...
                    margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 0.5*fem, 32*fem),
                    width: 204*fem,
                    height: 50*fem,
                    child: Stack(
                      children: [
              ...
              child: Row(
                ...
                children: [
                  Container(
                    ...
                    padding: EdgeInsets.fromLTRB(130.5*fem, 139*fem, 124.5*fem, 111*fem),
                    width: 529*fem,
                    height: double.infinity,
                    decoration: BoxDecoration (
                    ...
                    child: Column(
                      ...
                      children: [
                        Container(
                          // J4U (17:901)
                          margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 5*fem, 70*fem),
                          width: 130*fem,
                          height: 168*fem,
                          child: Image.asset(
